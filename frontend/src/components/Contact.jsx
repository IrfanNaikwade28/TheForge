        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-7">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-[#F04A1D] hover:bg-[#C83410] text-white font-black text-sm uppercase tracking-wider px-6 py-4 rounded-xl transition-colors duration-200 shadow-lg shadow-[#F04A1D]/20"
            >
