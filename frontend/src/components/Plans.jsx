    ...
    <section id="plans" className="bg-[#0F0F0F] py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <AnimatedSection className="text-center mb-14">
          <SectionHeading label="Membership" center>
            Simple Plans.
            <br />
            ...
            <AnimatedSection key={i} delay={i * 120}>
              <div
                ...
                onMouseEnter={e => {
                  ...
                  if (!plan.highlight) {
                    ...
                    e.currentTarget.style.borderColor = "rgba(240,74,29,0.4)";
                  } else {
                    e.currentTarget.style.boxShadow = "0 16px 40px rgba(240,74,29,0.25)";
                  }
                }}
                onMouseLeave={e => {
              ...
              >
                ...
                <div className={`p-7 pb-5 ${plan.highlight ? "bg-[#F04A1D]/5" : ""}`}>
                  <p className="text-[#B8B8B8] text-xs font-semibold uppercase tracking-[0.2em] mb-1">
                    {plan.duration}
                  </p>
                  <h3
